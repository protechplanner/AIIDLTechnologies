...
export const ContactInfosList = [
  {
    ...
    infos: [
      ...
      {
        name: "info@aiidltechnologies.com"
      },
      {
...
export const ServicePostData = [
  {
    title: "Modren Design",
    text:
      "AIIDL Technologies Pvt Ltd's modern design embodies elegance and innovation.",
  ...
  },
  {
    ...
    text:
      "Cutting-edge digital products crafted for seamless user experience and innovation.",
  ...
  },
  {
    ...
    text:
      "Strategic marketing plans tailored for maximum impact and audience engagement.",
